...
alias ctrash='sudo rm -rf $HOME/.local/share/Trash/* && echo "System trash folder cleaned"'
...
alias bl='xrandr --output eDP-1 --brightness $1'
alias monattach='xrandr --output HDMI-1-0 --auto --right-of eDP-1'
